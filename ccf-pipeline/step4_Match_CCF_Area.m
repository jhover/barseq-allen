clc
clearvars
match_CCF(fullfile('newsliceimages','small','ccf_streamline_registered_filt_neurons.csv'),'filt_neurons-bc-complexity-clust.mat') % if no CCF registration, use 0 as input to use original coordinates inplace of CCF
%%
